  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-selected:bg-background data-selected:text-foreground dark:data-selected:border-input dark:data-selected:bg-input/30 dark:data-selected:text-foreground data-selected:shadow-sm",
